                    ...
                    <div class="col-12 col-sm-12 col-md-6 banner-1">
                        <div class="small-banner-1 position-relative">
                            <a class="animate-scale" href="shop-grid-left-sidebar.html"><img
                                    class="img-fluid blur-up lazyload w-100" src="views/images/banner/banner-1.jpg"
                                    data-src="views/images/banner/banner-1.jpg" alt="image" title="image"/></a>
                        ...
                        <div class="row mb-5">
                                ...
                                <div class="small-banner-2 position-relative">
                                    <a class="animate-scale" href="shop-grid-left-sidebar.html">
                                        <img class="img-fluid blur-up lazyload w-100"
                                             src="views/images/banner/banner-2.jpg"
                                             data-src="views/images/banner/banner-2.jpg" alt="image"
                                             title="image"/>
                                        <div class="banner-details">
                                            <h3>Batteries</h3>
                                        </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-6">
                                <div class="small-banner-3 position-relative">
                                    <a class="animate-scale" href="shop-grid-left-sidebar.html">
                                        <img class="img-fluid blur-up lazyload w-100"
                                             src="views/images/banner/banner-3.jpg"
                                             data-src="views/images/banner/banner-2.jpg" alt="image"
                                             title="image"/>
                                        <div class="banner-details">
                                            <h3>Engine</h3>
                            ...
                            <div class="col-12 col-sm-12">
                                <div class="small-banner-4 position-relative">
                                    <a class="animate-scale" href="shop-grid-left-sidebar.html">
                                        <img class="img-fluid blur-up lazyload w-100"
                                             src="views/images/banner/banner-3.jpg"
                                             data-src="views/images/banner/banner-3.jpg" alt="image"
                                             title="image"/>
                                        <div class="banner-details">
                                            <h3>Motor Bike</h3>
                                            <p>Parts</p>
...
<!-- ******** JS Files ******** -->
<!-- Plugin JS -->
<script src="views/script/plugins.js"></script>
