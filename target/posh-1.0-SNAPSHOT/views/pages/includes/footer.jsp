        ...
        <div class="container">
            <div class="row no-gutters">
                <div class="col-12 col-sm-12 col-md-12 col-lg-3 logo-wellcome">
                    <div class="ftr-logo">
                        <a href="index.html"><img class="img-fluid" src="../images/logo/gray-logo.png"
                                                  alt="Posh Auto Parts" title="Posh Auto Parts"/></a>
                    </div>
                    <div class="welcome-text">
                        <p class="m-0">Lorem ipsum dolor sit amet,<br> consectetuer adipiscing elit. Donec odio. Quisque
                    ...
                    <div class="row no-gutters footer-links">
                        ...
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3 contact">
                            ...
                            <ul class="linklist contact-info d-flex flex-column">
                                <!-- 28 Km by Cairo / Alexandria Desert Road, <br/>6 October, Egypt -->
                                <li><i class="icon ti-location-pin"></i><span>Alexandria Desert Road, <br/>6 October, Egypt</span>
                                </li>
                                <li><i class="icon fa fa-phone"></i><a href="tel:+011234567890">(+01) 123 456 7890</a>
                                </li>
                                <li><i class="icon ti-email"></i><a href="mailto:info@example.com">info@example.com</a>
                                </li>
                            </ul>
                        </div>
                    </div>
